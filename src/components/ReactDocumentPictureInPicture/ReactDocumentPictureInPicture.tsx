// Code inspired by https://github.com/martinshaw/react-document-picture-in-picture/tree/master
...
>((props, ref) => {
  ...
  const open = useCallback(async () => {
    ...
    pipWindow.current.addEventListener('resize', (event) => {
      if (props.onResize)
        props.onResize((event.target as Window).innerWidth, (event.target as Window).innerHeight)
    })
