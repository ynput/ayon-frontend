    ...
    <main>
      ...
      <section style={{ flexGrow: 1 }} className="invisible">
        <section className="invisible row">
          <Button label="Save current template" icon="pi pi-plus" />
          <Button label="Save as a new template" icon="pi pi-plus" />
          <Button label="Delete the template" icon="pi pi-times" />
          <Button label="Set as default template" icon="pi pi-times" />
          <div style={{ flexGrow: 1 }} />
          <Button label="Create a project" icon="pi pi-plus" />
        </section>
