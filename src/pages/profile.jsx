...
import {FormLayout, FormRow, InputText, Password, Button} from '/src/components'
      ...
      <div>
        ...
        <FormLayout>
          <FormRow label="New password">
            <Password value={pass1} onChange={e => setPass1(e.target.value)}/>
          </FormRow>
          <FormRow label="Confirm password">
            <Password value={pass2} onChange={e => setPass2(e.target.value)}/>
          </FormRow>
          <FormRow>
            <Button label="Update password" onClick={savePassword} disabled={passInvalid}/>
          </FormRow>
        </FormLayout>
