...
// Current
const enhancedApi = API.rest.enhanceEndpoints({
  addTagTypes: ['User'],
  endpoints: {
    getProject: {
...
export const { useGetProjectQuery, useListProjectsQuery, useGetProjectAnatomyQuery } = enhancedApi

export const { useGetProjectAttribsQuery, useGetProjectLatestQuery } = getProject
