import { UploadAddonZipFileApiArg } from '../addons'
import { getAddonsApi as api } from './getAddons'
import { FetchBaseQueryError } from '@reduxjs/toolkit/query'

const updateAddonsApiEnhanced = api.enhanceEndpoints({
  endpoints: {
    deleteAddonVersion: {
...
export const updateAddonsApi = updateAddonsApiEnhanced.injectEndpoints({
  endpoints: (build) => ({
