...
export type FolderAttribFragment = { __typename?: 'FolderNode', allAttrib: string };
...
export const VersionBaseFragmentDoc = `
  ...
  version
    ...
    `;
export const FolderAttribFragmentDoc = `
    fragment FolderAttrib on FolderNode {
  allAttrib
}
    `;
